  ...
  methods: {
    ...
    results: function() {
      getResults(this.interviewId)
        .then(results => {
          this.health =
            results.data.status_health_activity +
            results.data.status_health_event;
          this.family =
            results.data.status_family_activity +
            results.data.status_family_event;
          this.work =
            results.data.status_work_activity + results.data.status_work_event;
          this.money =
            results.data.status_money_activity +
            results.data.status_money_event;
        })
        .catch(error => {
